...
impl ClientPoolManager {
    ...
    pub fn get_client(&self,clientid:u64) -> Option<&HashMap<u32,Arc<tokio::sync::Mutex<SendStream>>>> {
        self.client_pool.get(&clientid)
    }
    pub fn remove_client(&mut self,clientid:u64,deviceid:u32) -> Option<HashMap<u32,Arc<tokio::sync::Mutex<SendStream>>>> {
    ...
    pub fn put_client(&mut self,clientid:u64,deviceid:u32,streamid:Arc<tokio::sync::Mutex<SendStream>>) ->Option<&HashMap<u32,Arc<tokio::sync::Mutex<SendStream>>>> {
