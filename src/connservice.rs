...
pub struct ClientPoolManager {
    ///
    client_pool : HashMap<u64,HashMap<u32,u64>>, // clientid,deviceid,streamid
    /// 
...
impl ClientPoolManager {
    ...
    pub fn get_client(&self,clientid:u64) -> Option<&HashMap<u32,u64>> {
        self.client_pool.get(&clientid)
    }
    pub fn remove_client(&mut self,clientid:u64,deviceid:u32) -> Option<HashMap<u32,u64>> {
    ...
    pub fn put_client(&mut self,clientid:u64,deviceid:u32,streamid:u64) ->Option<&HashMap<u32,u64>> {
        ...
        if self.client_pool.contains_key(&clientid) {
            ...
            let mut device_pool: HashMap<u32, u64> = HashMap::new();
            device_pool.insert(deviceid,streamid, );
